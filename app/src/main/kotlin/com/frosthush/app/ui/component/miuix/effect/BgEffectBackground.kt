...
package com.frosthush.app.ui.component.miuix.effect
...
fun BgEffectBackground(
    ...
    Box(
        ...
        // 平板/大屏（最小宽度 ≥600dp）用 PAD 预设，手机用 PHONE 预设（KernelSU 用分栏判断，本项目无分栏）
        val deviceType = if (LocalConfiguration.current.smallestScreenWidthDp >= 600) DeviceType.PAD else DeviceType.PHONE
